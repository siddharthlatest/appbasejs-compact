 ...
 * @api public
  ...
  (function(){
    ...
    ab.server.search = Appbase.search = function(namespace, query, callback) {
    ...
    ab.interface.ref = function(path) {
      ...
      var internalFunctions = {
        ...
        onEdges: function(event, interfaceCallback, onlyNew) {
          ...
          if(!ab.server.edges.urlsListening[exports.URL()]) {
            var proceedListening = function(timestamp) {
              ab.server.edges.listen(exports.URL(), {"filters": {}, timestamp: timestamp}, function(error, request) {
                if(error) {
                  interfaceCallback(error)
            ...
            if(onlyNew) {
              ab.server.vertex.set(exports.URL(), {}, function(error, result) {
                if(!error)
                  proceedListening(result.timestamp)
                else
                  interfaceCallback(error)
              })
            } else {
      ...
      exports.on = function(event, callback, onlyNew) {
        ...
        var checkForCreationAndGoAhead = function() {
          if(ab.cache.newVertices[path]) {
            ...
            else internalFunctions.onEdges(event, callback, onlyNew)
          }
        }
      ...
      exports.isValid = function(callback) {
        var checkForCreationAndGoAhead = function() {
          if(ab.cache.newVertices[path]) {
            ...
            ab.server.vertex.get(exports.URL(), function(error, result) {
